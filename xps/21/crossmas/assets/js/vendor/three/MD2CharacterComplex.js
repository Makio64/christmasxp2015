...
THREE.MD2CharacterComplex = function () {
  ...
  this.setAnimation = function ( animationName ) {
    ...
    if ( this.meshBody ) {
      ...
      for (var i in this.animations) {
        var tmpAnimation = this.animations[i]
        if (this.activeAnimation!=tmpAnimation && animationName!=tmpAnimation ) {
          this.meshBody.setAnimationWeight( this.animations[i], 0 );
        };
      };
  ...
  this.updateBehaviors = function ( delta ) {
    ...
    //   moveAnimation = animations[ "chutte" ];
    //   idleAnimation = animations[ "chutte" ];
    ...
    // // set animations
    // // console.log("this.updateBehaviors "+moveAnimation)
  ...
  function createPart( geometry, skinMap ) {
    ...
    var materialTexture = new THREE.MeshBasicMaterial( { color: 0xffffff, wireframe: false, map: skinMap, morphTargets: true, morphNormals: true, transparent: true } );
