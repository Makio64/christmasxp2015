...
WAGNER.processShader = function( vertexShaderCode, fragmentShaderCode ) {
	...
	var typesMap = {
		...
		mat3: { type: 'm3', value: function() { return new THREE.Matrix3(); } },
		mat4: { type: 'm4', value: function() { return new THREE.Matrix4(); } }
...
WAGNER.GenericPass = function( fragmentShaderSource, c ) {
	...
	WAGNER.Pass.call( this );
	var self = this;
	this.loadShader( fragmentShaderSource, c );
