...
'  }',
'  vScale = clamp( vScale, 0., 1. );',

'	 float pixelWidth = finalPosition.w * pixelWidthRatio;',
'float w = ( 1.8 * pixelWidth * lineWidth + sin(width+time) * .1 );',

' w *= smoothstep(uv.x*2.,uv.y*2.+2.,time*500.) * vScale;',
// ' vec2 dir = normalize( currentP - prevP );',
'    vec2 dir;',
...
'void main() {',
'',
'    vec4 c = vColor * texture2D( map, vUV );',
// '    c.a *= alpha;',
'    gl_FragColor = c;',
'',   
'}' ];
